...
# MFD-Sysctl documentation build configuration file, created by
...
htmlhelp_basename = "mfd-sysctl-doc"
...
latex_documents = [
    (master_doc, "mfd-sysctl.tex", "MFD-Sysctl Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-sysctl", "MFD-Sysctl Documentation", [author], 1)]
